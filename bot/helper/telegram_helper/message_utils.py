...
def update_all_messages():
    ...
    msg += f"<b>𝗖𝗣𝗨 :</b> {psutil.cpu_percent()}%" \
           f" <b>𝗥𝗔𝗠:</b> {psutil.virtual_memory().percent}%" \
           f" <b>𝗗𝗜𝗦𝗞 :</b> {psutil.disk_usage('/').percent}%"
    with download_dict_lock:
        ...
        msg += f"\n<b>𝗙𝗥𝗘𝗘 :</b> {free} | <b>𝗨𝗣𝗧𝗜𝗠𝗘 :</b> {currentTime}\n<b>𝗗𝗟 :</b> {dlspeed}/s 🔻 | <b>𝗨𝗟 :</b> {ulspeed}/s 🔺\n"
    with status_reply_dict_lock:
...
def sendStatusMessage(msg, bot):
    ...
    progress += f"<b>𝗖𝗣𝗨 :</b> {psutil.cpu_percent()}%" \
           f" <b>𝗥𝗔𝗠 :</b> {psutil.virtual_memory().percent}%" \
           f" <b>𝗗𝗜𝗦𝗞 :</b> {psutil.disk_usage('/').percent}%"
    with download_dict_lock:
        dlspeed_bytes = 0
